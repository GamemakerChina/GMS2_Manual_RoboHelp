...
![Inspecting Sequence
Track](/assets/Images/IDE%20Tools/Inspector.png)

![Inspecting Sound
Asset](/assets/Images/IDE%20Tools/Inspector_Sound.png)
...
![](/assets/Images/IDE%20Tools/Inspector_Opening_Windows.png)  
...
![](/assets/Images/IDE%20Tools/Inspector_Object_Editing.png)  
...
and then click the
![](/assets/Images/Icons/Icon_Padlock.png) lock
button on the inspector to lock it on the element (shown in the image
below). Once you have locked an inspector, you can open another one and
then repeat the process.  
![](/assets/Images/IDE%20Tools/Inspector_Lock.png)  
