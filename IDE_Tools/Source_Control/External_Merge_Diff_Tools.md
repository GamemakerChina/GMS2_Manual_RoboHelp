...
![](/assets/Images/IDE%20Tools/SCM_ConflictsWindow.png)  
...
![](/assets/Images/IDE%20Tools/SCM_ChooseMergeTool.png)  
...
![](/assets/Images/IDE%20Tools/SCM_MergeConfirm.png)  
...
![](/assets/Images/IDE%20Tools/SCM_MergeInProgress.png)  
...
![](/assets/Images/Icons/Icon_LMB.png) on the top
one and then
![](/assets/Images/Icons/Icon_Shift.png) +
![](/assets/Images/Icons/Icon_LMB.png) on the
bottom one to select them all. Next, we right click on the selected
files and choose **Delete Path** to remove them. There's also a commit
message pre-filled for us as well, stating that this was a merge, and
that there was a conflict (we can add to this or edit it as we wish). We
can click **Commit** now. Due to the fact that you can have issues with
other files, it means that your workflow when using remote or shared
...
![](/assets/Images/IDE%20Tools/SCM_ChooseDiffTool.png)  
