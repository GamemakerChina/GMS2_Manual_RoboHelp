...
:  
![](/assets/Images/Setup_And_Version/Preferences/Plugins_Git_Prefs.png)  
...
![](/assets/Images/Icons/Icon_Browse.png) button
and manually select the git.exe file included in cmd folder of your Git
installation, which is usually inside C:\Program Files\Git\\ . For the
rest of the Git options, see the [Plugin
...
![](/assets/Images/IDE%20Tools/SCM_EnableSourceControl.png)  
