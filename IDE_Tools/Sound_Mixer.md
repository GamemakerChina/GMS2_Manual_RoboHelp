...
![](/assets/Images/IDE%20Tools/Audio_Mixer.png)  
...
sounds in the [Asset Browser](../Introduction/The_Asset_Browser) and
then open the right click
![](/assets/Images/Icons/Icon_RMB.png) menu and
select **Open In Sound Mixer** . Alternatively, you can click
![](/assets/Images/Icons/Icon_LMB.png) on a sound
asset and drag it into the mixer. The mixer itself is split into the
following sections:
...
-   **Sound Resources** : This part of the column view shows each of the
    ...
    ![](/assets/Images/Icons/Mixer_CloseColumn.png)
...
-   **Link Columns** : The Link Columns button
    ![](/assets/Images/Icons/Mixer_LinkColumns.png)
