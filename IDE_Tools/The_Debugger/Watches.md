...
![](/assets/Images/Icons/Debug_RealTime.png) is
enabled from the Debugger toolbar) while others will require the
...
variable value and get a pop-up window that lists the available
data-types that this variable could be:  
![](/assets/Images/IDE%20Tools/Debug_DataTypes.png)  
...
![](/assets/Images/Icons/Debug_Expand.png) next to
its name. This will expand the structures contents, and you can also
change some of the values for the variables shown by simply double
clicking ![](/assets/Images/Icons/Icon_LMB.png) on
the value and giving it a new one. **NOTE** : you cannot re-assign
...
![](/assets/Images/IDE%20Tools/Debug_Local_Window.png)  
...
![](/assets/Images/Icons/Debug_Expand.png) to see a
list of all local and instance variables that are currently declared for
the code block being stepped through. If you right click
![](/assets/Images/Icons/Icon_RMB.png) on a value
you can set its **type** to see details of data structures. [ Globals
Globals ](#)  
![](/assets/Images/IDE%20Tools/Debug_Global_Window.png)  
The **Globals** window will show a list of all the currently declared
**global** variables and their values. If you right click
![](/assets/Images/Icons/Icon_RMB.png) on a value
you can set its **type** to see details of data structures. [ Watches
Watches ](#)  
![](/assets/Images/IDE%20Tools/Debug_Watch_Window.png)  
...
![](/assets/Images/IDE%20Tools/Debug_Instance_Watches.png)  
...
![](/assets/Images/Icons/Icon_RMB.png) on a value
you can set its **type** , delete it, or clear all watches from the
window. [ All Instances All Instances ](#)  
![](/assets/Images/IDE%20Tools/Debug_AllInstance_Watches.png)  
...
![](/assets/Images/Icons/Icon_RMB.png) on a value
to set its **type** . [ Selected Instance Selected Instance ](#)  
![](/assets/Images/IDE%20Tools/Debug_SelectedInstance_Watches.png)  
...
States ](#)  
![](/assets/Images/IDE%20Tools/Debug_RenderState_Window.png)  
...
Textures ](#)  
![](/assets/Images/IDE%20Tools/Debug_SurfaceTexture_Window.png)  
...
pop-up window:  
![](/assets/Images/IDE%20Tools/Debug_Textures.png)  
...
consecutive buffer:  
![](/assets/Images/IDE%20Tools/Debug_Buffer.png)  
If you right click
![](/assets/Images/Icons/Icon_RMB.png) on the data
window or click the **Data Display** button, you can select how the data
is displayed, setting the *alignment* and *type* , and you can also set
how the data is laid out from the **Column Select** box. There is a
drop-down window here where you can select from a default list of
layouts.
