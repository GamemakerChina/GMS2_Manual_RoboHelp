...
![](/assets/Images/IDE%20Tools/Debug_Profile.png)  
...
the entries to have it open in the **Source** debug window if you have
one. If you see a
![](/assets/Images/Icons/Debug_Expand.png) icon
beside a name then there are further script or function calls within
that section, and clicking the
![](/assets/Images/Icons/Debug_Expand.png) will
expand the tree to show them. Selecting the **Bottom Up** view mode will
show things from the bottom up so you can see all the functions and
script calls individually. When using this view mode, clicking on the
![](/assets/Images/Icons/Debug_Expand.png) will
expand the function or script to show what actually called it. [ View
Target View Target ](#) The **View Target** permits you to choose
...
![](/assets/Images/Icons/Debug_Expand.png) to
expand these out to see them. The profile data is shown in four columns,
and clicking on any of them will sort the data according to the column
criteria.  
![](/assets/Images/IDE%20Tools/Profiler_Display.gif)  

-   **Name** : This is the name of the event, script or function being
    called, and may have a
    ![](/assets/Images/Icons/Debug_Expand.png)
    ...
    **View Mode** you have selected). You can double click
    ...
    of the names to have it open the code block or script within the
    Source window. Clicking the top of this column will sort the names
