...
![](/assets/Images/QS_Guide/QS_SoundEditor.png)  
...
![](/assets/Images/Icons/Icon_AddSound.png) and
then browsing in the file explorer that opens to the file you want to
use (you can also drag and release sound files onto the GameMaker IDE
