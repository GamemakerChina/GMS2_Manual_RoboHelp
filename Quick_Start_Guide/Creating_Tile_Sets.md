...
top down game:  
![](/assets/Images/QS_Guide/QS_ExampleTileset.png)  
...
![](/assets/Images/QS_Guide/QS_Tileset_Sprite.png)  
...
![](/assets/Images/Icons/Icon_RMB.png) the Tile Set
asset folder and selecting *Create* . This will open the [Tile Set
Editor](../The_Asset_Editors/Tile_Sets) where you can then add the
sprite and set its properties:  
![](/assets/Images/QS_Guide/QS_Tileset_Editor.png)  
