...
Objects asset folder and select *Create* (or right click anywhere in the
[Asset Browser](../Introduction/The_Asset_Browser) and select
*Create Object* ).  
![](/assets/Images/QS_Guide/QS_ObjectEditor.png)  
...
![](/assets/Images/Icons/Icon_AddSound.png) button.
This will open the **Asset Explorer** where you can select the sprite to
use (you can also drag sprites from the Asset Browser and drop them onto
the Object Editor to assign them):  
![](/assets/Images/QS_Guide/QS_AssetExplorer.png)  
If you do not have an appropriate sprite yet, you can click
![](/assets/Images/Icons/Icon_LMB.png) on the *New
Sprite* button
![](/assets/Images/Icons/Icon_NewSprite.png) to
create a new sprite asset and edit it as you wish, just as if you had
...
![](/assets/Images/Icons/Icon_LMB.png) on the *Edit
Sprite*
![](/assets/Images/Icons/Icon_EditSprite.png) or
*Edit Image*
![](/assets/Images/Icons/Icon_EditImage.png)
...
Event button:  
![](/assets/Images/QS_Guide/QS_ObjectEditor_Events.png)  
...
![](/assets/Images/QS_Guide/QS_ObjectEditor_Chain.png)  
