...
![](/assets/Images/Icons/Icon_LMB.png) . To start
with, open an object, assign it a sprite, and then give it a **Global
Left Mouse Down event** :  
![](/assets/Images/QS_Guide/QS_Add_GlobalLMBDownEvent.png)  
...
![](/assets/Images/QS_Guide/QS_MovementExample_DnD_1_1.png)  
...
![](/assets/Images/Icons/Icon_PlayGame.png) , then
click ![](/assets/Images/Icons/Icon_LMB.png) around
the room to make the instance move towards the mouse:  
![](/assets/Images/QS_Guide/QS_MovementExample_1_1.gif)  
...
![](/assets/Images/QS_Guide/QS_MovementExample_DnD_1_2.png)  
...
![](/assets/Images/Icons/Icon_PlayGame.png) and
test it now. Before we leave this example, there is one final issue that
we need to resolve... If you click and *hold* the mouse button, but
...
immediately obvious).  
![](/assets/Images/QS_Guide/QS_MovementExample_1_2.gif)  
To solve this we need to add a **Step Event** to the object with this
code:  
![](/assets/Images/QS_Guide/QS_MovementExample_DnD_1_3.png)  
...
step:  
![](/assets/Images/QS_Guide/QS_DnD_Example.png)  
...
![](/assets/Images/QS_Guide/QS_MovementExample_DnD_2_1.png)  
...
**Play** button
![](/assets/Images/Icons/Icon_PlayGame.png) to test
it now! If all has gone correctly, you should have something like
this:  
![](/assets/Images/QS_Guide/QS_MovementExample_2_1.gif)  
...
![](/assets/Images/QS_Guide/QS_MovementExample_DnD_2_2.png)  
...
![](/assets/Images/Icons/Icon_PlayGame.png) it'll
look something like this:  
![](/assets/Images/QS_Guide/QS_MovementExample_2_2.gif)  
...
![](/assets/Images/QS_Guide/QS_MovementExample_DnD_3_1.png)  
...
![](/assets/Images/QS_Guide/QS_MovementExample_DnD_3_2.png)  
...
**![](/assets/Images/Icons/Icon_PlayGame.png)** ,
then move around using the left stick of your connected gamepad. You
should see something like this:  
![](/assets/Images/QS_Guide/QS_MovementExample_3_1.gif)  
...
![](/assets/Images/QS_Guide/QS_MovementExample_4_1.png)  
...
horizontal:  
![](/assets/Images/QS_Guide/QS_MovementExample_4_2.png)  
...
![](/assets/Images/QS_Guide/QS_MovementExample_DnD_4_1.png)  
...
![](/assets/Images/QS_Guide/QS_MovementExample_DnD_4_2.png)  
...
explain it in words:  
![](/assets/Images/QS_Guide/QS_MovementExample_4_3.png)  
...
**![](/assets/Images/Icons/Icon_PlayGame.png)** ,
and you should get silky-smooth 8 way movement without any of the issues
related to moving diagonally:  
![](/assets/Images/QS_Guide/QS_MovementExample_4_4.gif)  
