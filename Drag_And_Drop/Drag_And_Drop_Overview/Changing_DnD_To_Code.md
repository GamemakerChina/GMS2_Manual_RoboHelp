...
**Live Preview** :  
![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_Preview_RMBMenu.png)  
Which will open a new window:  
![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_Preview.png)  
...
![](/assets/Images/Icons/Icon_RMB.png) in any event
workspace with actions and selecting **Convert To GML Code** .  
![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_Code_RMBMenu.png)  
...
![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_Code.png)  
...
![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_InstanceExists.png)  
Will become this code:  
![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_Code_InstanceExists.png)  
...
code editor and selecting " **Convert To GML Visual** ". This will place
the previously created code within an [Execute
Code](../Drag_And_Drop_Reference/Common/Execute_Code) action and you
can then continue to use GML Visual as before:  
![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_ExecuteCode.png)  
