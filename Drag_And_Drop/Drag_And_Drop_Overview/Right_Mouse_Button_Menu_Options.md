...
button ![](/assets/Images/Icons/Icon_LMB.png) on
the action, on the workspace, or on the text in the shortlist on the
left to open up the Right Mouse button menu:  
![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_RMB_Menu.png)  
...
-   **Cut** / **Copy** / **Paste** : This will permit you cut, copy or
    ...
    ![](/assets/Images/Icons/Icon_LMB.png) outside
    of the actions and drag, or use
    ![](/assets/Images/Icons/Icon_Ctrl.png) /
    ![](/assets/Images/Icons/Icon_Cmd.png) +
    ![](/assets/Images/Icons/Icon_LMB.png) on
    individual actions, to select more than one and apply the command to
    all of them.
-   **Comment** / **Remove Comment** : This option permits you to add
    ...
    the image below:  
    ![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_Comments_In_GML.png)  
    ...
    ![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_Comments_Extended.png)  
...
-   **Disable** / **Enable** : These commands can be used disable or
    ...
    actions disabled:  
    ![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_Disable_Actions.png)  
...
-   **Toggle Breakpoint** : This command will toggle a breakpoint on or
    ...
    ![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_ToggleBreakpoint.png)  
...
-   **Collapse All** / **Expand All** : GML Visual actions can be either
    ...
    ![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_CollapseActions.png)  
...
-   **Window** : This section opens the following sub-menu:  
    ![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_WindowOptions.png)  
    ...
    -   **Single Pane** / **2 Columns** / **3 Columns** : These options
        ...
        workspace pane:  
        ![](/assets/Images/Scripting_Reference/Drag_And_Drop/Overview/DnD_SplitPaneWindow.png)  
...
-   **Show Help...** : Selecting this will open the Manual in a new
    ...
    ![](/assets/Images/Icons/Icon_f1.png) on the
    node.
