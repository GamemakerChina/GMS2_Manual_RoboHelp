...
![](/assets/Images/Scripting_Reference/Drag_And_Drop/Reference/Switch/Lib_Switch.png)  
...
|                                                                                                                    |                        |
|--------------------------------------------------------------------------------------------------------------------|------------------------|
| ![](/assets/Images/Scripting_Reference/Drag_And_Drop/Reference/Switch/i_Switches_Switch.png)  | [Switch](Switch)   |
| ![](/assets/Images/Scripting_Reference/Drag_And_Drop/Reference/Switch/i_Switches_Case.png)    | [Case](Case)       |
| ![](/assets/Images/Scripting_Reference/Drag_And_Drop/Reference/Switch/i_Switches_Default.png) | [Default](Default) |
