...
![](/assets/Images/Introduction/Output_General.png)  
...
you can click
![](/assets/Images/Icons/Icon_LMB.png) and drag any
tab in the docked window to another dock to change its position, or you
can click ![](/assets/Images/Icons/Icon_LMB.png) on
the dock contents bar and drag it into the workspace to create a
stand-alone window:  
![](/assets/Images/Introduction/Output_Window.gif)  
You can also click
![](/assets/Images/Icons/Icon_LMB.png) and drag a
docked output into another one to create a split view output window, as
shown in the example below where the two error outputs have been placed
within the same tab (you can slow click
![](/assets/Images/Icons/Icon_LMB.png) on a tab to
change its name too):  
![](/assets/Images/Introduction/Output_SplitWindow.gif)  
...
![](/assets/Images/Introduction/Output_Output.png)  
...
![](/assets/Images/Introduction/Output_Search.png)  
You can open the **Search And Replace Window** using the keyboard
shortcut ![](/assets/Images/Icons/Icon_Ctrl.png) /
![](/assets/Images/Icons/Icon_Cmd.png) +
![](/assets/Images/Icons/Icon_Shift.png) + " **F**
", or go to the [Edit Menu](../IDE_Navigation/Menus/The_Edit_Menu) .
Once you have entered your search terms, the results will be shown in
this window with the format:
...
the returned entries to open the given asset at the correct position for
editing. [ Source Control Source Control ](#)  
![](/assets/Images/Introduction/Output_SourceControl.png)  
...
![](/assets/Images/Introduction/Output_Breakpoints.png)  
...
one then you get a small menu that permits you to remove the breakpoint
or open the code/GML Visual window where the breakpoint is located. [
Syntax Errors Syntax Errors ](#)  
![](/assets/Images/Introduction/Output_SyntaxErrors.png)  
...
left mouse button
![](/assets/Images/Icons/Icon_LMB.png) to open a
window at the position flagged so it can be resolved. Syntax errors will
update as you write your code (there will be a short pause between
typing something and any errors appearing in this window to prevent
...
![](/assets/Images/Introduction/Output_CompileErrors.png)  
...
You can then double-click
![](/assets/Images/Icons/Icon_LMB.png) on any of
the compiler error entries to open the given asset at the position
flagged as giving the error. For a full list of possible error messages,
please see [here](../Additional_Information/Errors/Compiler_Errors)
.
