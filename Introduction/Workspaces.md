...
![](/assets/Images/Introduction/QS_Workspace.png)  
...
![](/assets/Images/Introduction/Icon_Add.png) to
the side, giving you multiple possible workspaces for any single
...
and - still holding the mouse button
![](/assets/Images/Icons/Icon_LMB.png) down - drag
it off of the main IDE window into its own individual window, making it
very easy to organise things if you are using - for example - multiple
displays. You also merge these secondary workspace windows back into the
main one by dragging the tab back onto the first window. Note that
although you appear to have two instances of the IDE running when you do
this, they are **both for the same project** and you cannot have one
project in one and another in the other unless you specifically open two
instances of GameMaker . When you first start GameMaker , your workspace
will already be populated by a couple of windows which will be "
**docked** " to the IDE. These are explained briefly below:
...
-   **Assets** - On the right of the screen you can find the [**Asset
    ...
    ![](/assets/Images/Icons/Icon_RMB.png) on an
    asset folder (or anywhere in the main Asset Browser view) and
    ...
    ![](/assets/Images/Introduction/QS_ResourcesMenu.png)  
    ...
    "Asset Browser" text at the top and dragging. You can re-dock it
    again at any time by dragging it to the sides or bottom of the IDE.
    If you close the Asset Browser window and wish to recover it you can
    use the [Windows Menu](../IDE_Navigation/Menus/The_Windows_Menu)
    . For more information on the available assets please see the
    section on [Editors](../The_Asset_Editors/The_Asset_Editors) .
...
![](/assets/Images/Icons/Icon_RMB.png) anywhere,
which will open the following menu:  
![](/assets/Images/Introduction/QS_RMB_Options.png)  
...
![](/assets/Images/Introduction/QS_Goto.png)  
...
![](/assets/Images/Icons/Icon_Cmd.png) + **T** to
open the Go To window, and that the number of items listed is (by
default) set to a maximum of 16. You can change this maximum limit along
with other search options in the **Go To** section of the [General
...
docked. If you click
![](/assets/Images/Icons/Icon_LMB.png) on, for
example, the Asset Browser tab at the top and drag it to the left of the
current workspace, you will see that it becomes a free floating
window.  
![](/assets/Images/Introduction/QS_UnDocking.gif)  
...
window there:  
![](/assets/Images/Introduction/QS_Docking.gif)  
...
quick-button
![](/assets/Images/Icons/Icon_Docking.png) at the
top of the IDE, and note too that the IDE will remember docked windows
between sessions. **NOTE** : Some windows will disappear from the dock
when you change editors, like in the room editor. However when you
return to the editor in question, they will be re-opened in the dock
again.
...
|                                                                     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|---------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](/assets/Images/Icons/Icon_Home.png)        | Opens the Start Page in a new workspace                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ![](/assets/Images/Icons/Icon_NewProject.png)  | Create a new project.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ![](/assets/Images/Icons/Icon_OpenProject.png) | Open a previously created project.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ![](/assets/Images/Icons/Icon_Save.png)        | Save the current project. Note that by default GameMaker will save your project automatically (depending on the [Preferences](../Setting_Up_And_Version_Information/IDE_Preferences) that you have set) and this button is simply so you can force a save at any time.                                                                                                                                                                                                                                                                                                                           |
| ![](/assets/Images/Icons/Icon_Debug.png)       | Clicking this will test-run your current project along with the debug module. Use this to test and debug your game. You can find more about the debug module from the section on the [Debugger](../IDE_Tools/The_Debugger) .                                                                                                                                                                                                                                                                                                                                                                     |
| ![](/assets/Images/Icons/Icon_PlayGame.png)    | Clicking this will test-run your project on the chosen target platform.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ![](/assets/Images/Icons/Icon_StopGame.png)    | This button can be used to cancel the compilation of your games to the target module, or (on certain targets only) to stop the game while it is running after it has been compiled.                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ![](/assets/Images/Icons/Icon_Clean.png)       | Pressing this button will clear the current asset compiler cache. GameMaker stores images, sounds, scripts etc... between use in a cache so as to save time when testing your game as it will only re-compile those things that have been changed before testing. However, this cache may become corrupted or "stale" over time, or you may wish to do a full test with no caching being done previously, in which case you can clear the cache by pressing this button. **IMPORTANT** : It is recommended that you always clear the cache before creating the executable for any target platform.   |
| ![](/assets/Images/Icons/Icon_GameOptions.png) | Clicking this will open up the [Main Game Options Editor](../Settings/Game_Options) . Note that this is only the main, general, options for the current project, but you may also have platform specific options being listed as a part of the [Asset Browser](The_Asset_Browser) .                                                                                                                                                                                                                                                                                                          |
| ![](/assets/Images/Icons/Icon_Help.png)        | Click this to open the manual (or alternatively, press ![](/assets/Images/Icons/Icon_f1.png) ).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ![](/assets/Images/Icons/Icon_ZoomOut.png)     | This will zoom the focused workspace out to make everything smaller (you can also achieve this holding down ![](/assets/Images/Icons/Icon_Ctrl.png) / ![](/assets/Images/Icons/Icon_Cmd.png) and using the mouse wheel ![](/assets/Images/Icons/Icon_MMB.png) ).                                                                                                                                                                                                                                                                      |
| ![](/assets/Images/Icons/Icon_ZoomReset.png)   | This will reset the focused workspace to be 1:1 again.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ![](/assets/Images/Icons/Icon_ZoomIn.png)      | This will zoom the focused workspace in to make everything larger (you can also achieve this holding down ![](/assets/Images/Icons/Icon_Ctrl.png) / ![](/assets/Images/Icons/Icon_Cmd.png) and using the mouse wheel ![](/assets/Images/Icons/Icon_MMB.png) ).                                                                                                                                                                                                                                                                        |
| ![](/assets/Images/Icons/Icon_Docking.png)     | This will toggle all the docked elements between hidden and unhidden.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ![](/assets/Images/Icons/Icon_LaptopMode.png)  | This will toggle laptop mode on and off (This will only appear if you are currently using a laptop - see the section on [IDE Input](../IDE_Navigation/IDE_Input) for more details)                                                                                                                                                                                                                                                                                                                                                                                                               |
