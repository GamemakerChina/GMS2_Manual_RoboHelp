...
![](/assets/Images/Setup_And_Version/Preferences/General_OutputWindow_Prefs.png)  
The [**Output Window**](../../../Introduction/The_Output_Window)
preferences control the different colour and formatting options for the
various different output windows in the IDE. Each of the different
windows has the same set of options, which are listed below:
