...
![](/assets/Images/Setup_And_Version/Preferences/Redefine_Keys_Preferences.png)  
...
"). Enabling the
![](/assets/Images/Icons/Redefine_Keys_Search_Side_Button.png)
...
![](/assets/Images/Setup_And_Version/Preferences/Redefine_Search_Modes.gif)  
...
![](/assets/Images/Setup_And_Version/Preferences/Redefine_Keys_Preferences_Expanded.png)  
...
-   **Keys** : This displays the current keyboard mapping for the
    command. You can
    ![](/assets/Images/Icons/Icon_LMB.png) double
    click on any item in this column to reassign that command by simply
    pressing the appropriate combination of keys on the keyboard (they
    must be held simultaneously, similar to how the shortcut would
    ...
    one!](/assets/Images/Setup_And_Version/Preferences/Redefine_Example.gif)

    Pressing
    ![](/assets/Images/Icons/Icon_Escape.png) while
    editing a command will bring you out of edit mode and will not
    modify the selected command.

You can change the sorting of the Command List by
![](/assets/Images/Icons/Icon_LMB.png) clicking on
a column heading (either "Command" or "Keys") to sort the list using the
values from that column, alternating between ascending and descending
with each click.
...
![](/assets/Images/Setup_And_Version/Preferences/Redefine_Keys_Clash_Window.png)  
...
![](/assets/Images/Setup_And_Version/Preferences/Redefine_Keys_Filter_Menu.png)  
...
![](/assets/Images/Setup_And_Version/Preferences/Redefine_Clear_Button.png)  
