...
![](/assets/Images/Setup_And_Version/Preferences/General_Prefs.png)  
...
-   **Default Audio Device** : Here you can choose the default audio
    ...
    ![](/assets/Images/Icons/Icon_Refresh.png) .
...
-   **Enable DPI Override** : This option lets you override the default
    ...
    used:  
    ![](/assets/Images/Setup_And_Version/Preferences/General_DPi_Override_Recomendation.png)  
...
-   **Allow empty tabs to close via shortcut** : You can close any open
    ...
    ![](/assets/Images/Icons/Icon_Cmd.png) + **W**
    , but if you disable this option that shortcut will no longer work.
