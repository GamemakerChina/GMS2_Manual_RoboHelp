...
![](/assets/Images/Setup_And_Version/Preferences/Timeline_Prefs.png)  
...
-   **Automatic response to GML Visual conversion to GameMaker
    ...
    option on a timeline moment to convert GML Visual actions into
...
-   **Open new moments for edit on creation** : Normally when you add a
    ...
    moment). By default this option is on.
