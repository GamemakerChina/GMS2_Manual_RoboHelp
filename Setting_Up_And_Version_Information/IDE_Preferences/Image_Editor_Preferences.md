...
![](/assets/Images/Setup_And_Version/Preferences/Image_Editor_Prefs.png)  
...
-   **Expand sprite controls overlay by default** : When this is
    ...
    ![](/assets/Images/Icons/Icon_Collapse.png) ,
    but it will reopen on editing the sprite again later). When this is
    unchecked, the sprite controls and frame information will be hidden
    on opening a sprite. The default is to have this unchecked.
...
![](/assets/Images/Setup_And_Version/Preferences/ImageEditor_Background_Prefs.png)  
...
![](/assets/Images/Setup_And_Version/Preferences/ImageEditor_Confirm_Prefs.png)  
...
![](/assets/Images/Setup_And_Version/Preferences/ImageEditor_GridSettings_Prefs.png)  
...
[ Tools Tools ](#)  
![](/assets/Images/Setup_And_Version/Preferences/ImageEditor_Tools_Prefs.png)  
...
![](/assets/Images/Setup_And_Version/Preferences/Prefs_Arctool_Icon.png)
