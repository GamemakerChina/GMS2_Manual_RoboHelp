...
![](/assets/Images/IDE_Input/Recent_Windows.png)  
...
![](/assets/Images/Icons/Icon_RMB.png) on an item,
then you will open the following menu:  
![](/assets/Images/IDE_Input/Recent_Windows_RMB_Menu.png)  
...
multiple) from the list or you can have them moved to the top of the
list. The RMB menu also has an additional option permitting you to clear
the list completely. It's worth noting that the Recent Windows list can
be docked to the sides of the IDE and you can also adjust certain
