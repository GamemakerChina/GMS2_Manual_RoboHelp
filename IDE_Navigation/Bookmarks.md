...
**NumberKey** \[1 - 9\] on Mac and this will set the bookmark, labeling
the item in the IDE as follows:  
![](/assets/Images/Introduction/QS_BookmarksIDE.png)  
...
go straight back to it again at any time later. This is done by pressing
![](/assets/Images/Icons/Icon_Ctrl.png) /
![](/assets/Images/Icons/Icon_Cmd.png) +
**NumberKey** \[1 - 9\] , and if the bookmarked item has been closed it
will be opened, otherwise the workspace will pan to the selected
