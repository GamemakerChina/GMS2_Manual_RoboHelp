...
![](/assets/Images/Asset_Editors/Editor_Shaders.png)  
...
![](/assets/Images/Icons/Icon_RMB.png) inside the
[Asset Browser](../Introduction/The_Asset_Browser) and select
*Create -\> Shader* . Once you have created the base shader, you can
then use the right mouse
![](/assets/Images/Icons/Icon_RMB.png) menu on the
new resource to select the shader type before continuing to edit the
code:  
![](/assets/Images/Asset_Editors/Editor_Shader_RMBMenu.png)  
