...
![](/assets/Images/Asset_Editors/Editor_Animation_Curves.png)  
...
clicking on the
![](/assets/Images/Icons/Animation_Curves_New_Channel.png)
...
menu where you can choose to rename, change the colour or delete the
channel. Channels can be expanded by clicking on the arrow beside the
...
new value.  
![](/assets/Images/Asset_Editors/Editor_Animation_Curves_ExpandList.png)  
...
![](/assets/Images/Icons/Icon_DeleteChannel.png) .
...
Channel List:  
![](/assets/Images/Asset_Editors/Editor_Animation_Curves_Channel_Editor.gif)  
...
![](/assets/Images/Asset_Editors/Editor_Animation_Curves_Channel_Editor_Moving.gif)  
...
![](/assets/Images/Asset_Editors/Editor_Animation_Curves_Channel_Editor_Presets.gif)  
...
to expand
![](/assets/Images/Icons/Icon_ZoomOut.png) or
contract ![](/assets/Images/Icons/Icon_ZoomIn.png)
the vertical scale of the channel curves in the Channel Editor. You can
also click the "Center Fit" button
![](/assets/Images/Icons/Icon_CenterFit.png) to
have the Channel Editor view adjust it's scale to fit all the points on
the channel curve within the editor, centered around the mid range of
the values:  
![](/assets/Images/Asset_Editors/Editor_Animation_Curves_Zoom.gif)  
