...
within the [Asset Browser](../../Introduction/The_Asset_Browser) and
select **Create -\> Extension** . This will open the Extension
properties for your newly created asset in the Workspace:  
![](/assets/Images/Asset_Editors/Editor_Extensions.png)  
...
![](/assets/Images/Icons/Icon_ExtensionMenu.png)
...
![](/assets/Images/Asset_Editors/Editor_Extensions_Files.png)  
...
![](/assets/Images/Asset_Editors/Editor_Extensions_FileProperties.png)  
...
![](/assets/Images/Asset_Editors/Editor_Extensions_AddFunctions.png)  
...
![](/assets/Images/Asset_Editors/Editor_Extensions_FunctionEditor.png)  
...
-   You can see that we have given the function a *Name* , which is what
    ...
    ![](/assets/Images/Asset_Editors/Editor_Extensions_FunctionNames.png)  
...
-   Under that you define the arguments that the function will take.
    ...
    ![](/assets/Images/Icons/Icon_RemoveArgument.png)
...
![](/assets/Images/Asset_Editors/Editor_Extensions_GMLFunctionExample.png)  
...
![](/assets/Images/Asset_Editors/Editor_Extensions_MacroEditor.png)  
...
Properties** window.  
![](/assets/Images/Asset_Editors/Editor_Extensions_ProxyFiles.png)  
...
extension and selecting *Open in Explorer* ), so if you need to edit
them, you should edit the copied files that are bundled with the game
and not the source file that was imported, as GameMaker will be using
the ones in the project for compiling.
