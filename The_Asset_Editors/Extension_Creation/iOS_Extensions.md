...
same):  
![](/assets/Images/Asset_Editors/Editor_Extensions_iOS.png)  
...
-   **System Frameworks** : Here you can add in any iOS system framework
    ...
    ![](/assets/Images/Icons/Icon_LMB.png) on it.
    You can find out more about available system frameworks
    ...
    button.  
    ![](/assets/Images/Asset_Editors/Editor_Extensions_iOS_Weak_Reference.png)  
...
-   **3rd Party Frameworks + Bundles** : This section is for adding
    third party and SDK bundles. As with system frameworks you click the
    ![](/assets/Images/Icons/Icon_AddArgument.png)
    button to add them and then double click
    ![](/assets/Images/Icons/Icon_LMB.png) to edit,
    and selecting them then clicking
    ![](/assets/Images/Icons/Icon_RemoveArgument.png)
    ...
    Signing** :  
    ![](/assets/Images/Asset_Editors/Editor_Extensions_iOS_Embed_Framework.png)  
...
-   **Enter framework path on Mac** : If you want to add a framework to
    ...
    extension and selecting *Open in Explorer* .
