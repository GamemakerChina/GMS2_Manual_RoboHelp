...
![](/assets/Images/Asset_Editors/Editor_Extensions_Android.png)  
...
-   **Android Permissions** : Here you can add in any extra permissions
    ...
    ![](/assets/Images/Icons/Icon_LMB.png) click on
    that to edit it to what is required. You can remove permissions
    using the
...
extension and selecting *Open in Explorer* . For information on your
creating native extensions for Android, see [Source
