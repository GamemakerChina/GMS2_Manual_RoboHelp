...
![](/assets/Images/Asset_Editors/Editor_Object_Variables.png)  
...
![](/assets/Images/Asset_Editors/Editor_Object_NewVariable.png)  
...
![](/assets/Images/Asset_Editors/Editor_Object_VariableTypes.png)  
...
-   **Real** : A real number is any number that is not a whole integer
    ...
    **integer** ) data types have an option for setting a range of
    ...
    ![](/assets/Images/Icons/Icon_VariableOptions.png)
    button:  
    ![](/assets/Images/Asset_Editors/Editor_Object_RealOptions.png)  
    ...
    to these values:  
    ![](/assets/Images/Asset_Editors/Editor_Object_VariableRange.png)  
...
-   **Resource** : A resource is simply any one of the resources that
    ...
    ![](/assets/Images/Icons/Icon_OpenAssetExplorer.png)
...
-   **Colour** : The colour type is for you to define a colour value to
    ...
    colour swatch to open the **Colour Picker** and define the colour
    there.
...
![](/assets/Images/Asset_Editors/Editor_Object_ChildVariables.png)  
...
![](/assets/Images/Icons/Icon_InheritedVariable.png)
...
![](/assets/Images/Icons/Icon_OverrideVariable.png)
...
![](/assets/Images/Icons/Icon_DeleteVariable.png)
