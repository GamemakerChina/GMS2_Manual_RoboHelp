...
![](/assets/Images/Asset_Editors/Editor_Tilesets.png)  
...
![](/assets/Images/Asset_Editors/Editor_Tilesets_Example.png)  
Images by [Lost
...
set:  
![](/assets/Images/Asset_Editors/Editor_Tilesets_AssetExplorer.png)  
You can also click on the **New Sprite** button
![](/assets/Images/Icons/Icon_NewSprite.png) button
to create a new sprite asset (which will open the [Sprite
...
even choose to edit the sprite image itself in the [Image
...
![](/assets/Images/Asset_Editors/Editor_Tilesets_Single.png)  
...
![](/assets/Images/Asset_Editors/Editor_Tilesets_Texel.png)  
...
you:  
![](/assets/Images/Asset_Editors/Editor_Tilesets_Smear.png)  
...
will reset the preview to be 1:1 with the tile set sprite being edited.
You can also click the **Window Fit** button
![](/assets/Images/Icons/Icon_CanvasFit.png) to
make the entire tile set fit within the current preview window (this
...
the canvas to be 1:1 with the tile set sprite. Another feature is that
you can switch the grid view on or off by clicking the
...
pan the preview (or alternatively use the
