...
![](/assets/Images/Asset_Editors/Editor_Sound.png)  
...
![](/assets/Images/Icons/Icon_OpenMixer.png) Icon
to open the sound in the [Sound Mixer](../IDE_Tools/Sound_Mixer) . [
OGG Conversion OGG Conversion ](#) This option is only available for
sounds that are in the OGG format and allows you to select one of these
two options:  
![](/assets/Images/Asset_Editors/Editor_Sound_Conversion_OGG.png)  
