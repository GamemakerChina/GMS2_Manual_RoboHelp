...
![](/assets/Images/Asset_Editors/Editor_Room_Inheritance.png)  
...
![](/assets/Images/Icons/Icon_RMB.png) . This will
open the room menu and there you can select **Create Child Room** to
create a new child room. This will be created in the Asset Browser:  
![](/assets/Images/Asset_Editors/Editor_RoomInheritance.png)  
...
room onto any other room to have it become a child of that room (or drag
a child room off a parent and break the inheritance).  
![](/assets/Images/Asset_Editors/Editor_Room_Inheritance_Manager.png)  
