...
![](/assets/Images/Asset_Editors/Editor_Room_Layers.png)  
...
![](/assets/Images/Icons/Icon_Eye.png) . If the
room has inherited layers from a parent room, you can toggle the
inheritance from the button at the bottom, but note that this will
...
![](/assets/Images/Icons/Icon_Cmd.png) and left
click ![](/assets/Images/Icons/Icon_LMB.png) on
multiple layers to select them for duplication or deletion (these
options are also available from the right mouse
![](/assets/Images/Icons/Icon_RMB.png) menu). To
help with ordering your layers and keeping them tidy, you can create
groups of layers in a layer folder by clicking the folder icon
![](/assets/Images/Icons/Icon_Folder.png) . You can
also delete one or more selected layers by clicking the delete button
![](/assets/Images/Icons/Icon_DeleteLayer.png) .
All layers will have a **depth** value, which defines where in the draw
order that layer will be placed when its contents are rendered in the
room. Layers are drawn from the *highest* depth to the *lowest* , so a
layer at a depth of -100 will be drawn *over* a layer with a depth of
...
If you right-click
![](/assets/Images/Icons/Icon_RMB.png) on any layer
you get the layer menu:  
![](/assets/Images/Asset_Editors/Editor_Room_LayerSubMenu.png)  
...
from one layer to another (including all those in between) or
![](/assets/Images/Icons/Icon_Ctrl.png) /
![](/assets/Images/Icons/Icon_Cmd.png) +
![](/assets/Images/Icons/Icon_LMB.png) to select
layers one at a time. If you place the layers on top of a layer folder,
they will be moved and set as sub-layers of the folder you dropped them
on to. You can also lock layers so that they cannot be edited by mistake
using the lock button
![](/assets/Images/Icons/Icon_Padlock.png) . NOTE
In the actual editor window where you place the different assets on
their layers, you can hold down " P " + click anywhere to instantly
...
![](/assets/Images/Icons/Icon_Background.png) [
...
properties window:  
![](/assets/Images/Asset_Editors/Editor_Room_BackgroundProperties.png)  
...
at the very top.
![](/assets/Images/Icons/Icon_Instance.png) [
Instances Instances ](#) You can add a new instance layer by clicking on
the ![](/assets/Images/Icons/Icon_Instance.png)
button. This will add the new layer, and then open up the instance
properties window:  
![](/assets/Images/Asset_Editors/Editor_Room_Instances.png)  
...
![](/assets/Images/Icons/Icon_Alt.png) to preview
the resource "in-situ", and if you additionally click the left mouse
button ![](/assets/Images/Icons/Icon_LMB.png) you
can add the instance and even "paint" it into the room layer by
maintaining the button pressed and moving the mouse. The layer list can
be ordered by clicking
![](/assets/Images/Icons/Icon_LMB.png) and dragging
an instance in the list to the position required, but it is worth noting
that this is purely for organisational purposes within the room editor
and if you want to set a specific creation order, please use the
**Creation Order Window** , which can be opened from the [Room
Properties](Room_Properties) window, or from the [Room context
menu](../Rooms) . Double-clicking
![](/assets/Images/Icons/Icon_LMB.png) on any
instance - either in the room editor itself or in the properties list -
will open a new window to let you modify aspects of that single unique
instance:  
![](/assets/Images/Asset_Editors/Editor_Room_InstanceProperties.png)  
...
feature with care.
![](/assets/Images/Icons/Icon_Tilemap.png) [ Tile
Maps Tile Maps ](#) You can add a new tile map layer by clicking on the
![](/assets/Images/Icons/Icon_Tilemap.png) button.
This will add the new layer, and then open up the **Tile Map Layer
Properties** window and the **Tile Editing** window:  
![](/assets/Images/Asset_Editors/Editor_Room_TileEditor.png)  
...
![](/assets/Images/Icons/Icon_LMB.png) on any tile
to select it as the current **brush** and then draw them to the layer in
the room editor by clicking
![](/assets/Images/Icons/Icon_LMB.png) on the room
canvas, or, if you want to draw multiple tiles together you can select
them as a group by clicking the left mouse
![](/assets/Images/Icons/Icon_LMB.png) and dragging
to select them from the tileset before drawing. If the range of tiles
that you want to draw together is not in a block, then you can hold down
![](/assets/Images/Icons/Icon_Ctrl.png) /
![](/assets/Images/Icons/Icon_Cmd.png) and then
select individual tiles using the left mouse button
![](/assets/Images/Icons/Icon_LMB.png) and create a
custom brush that way (you can also remove tiles from a custom brush
using ![](/assets/Images/Icons/Icon_Alt.png) +
![](/assets/Images/Icons/Icon_LMB.png) ). Note that
creating custom brushes this way is temporary and designed for one-off
uses, however you can use the **Editing Mode** in the
...
using the ![](/assets/Images/Icons/Icon_MMB.png)
middle mouse button or
![](/assets/Images/Icons/Icon_Space.png) +
![](/assets/Images/Icons/Icon_LMB.png) . Note that
there is a grid option too which can be toggled on or off to delimit the
tiles in the window, and you can set the colour of the grid as well,
although tiles will *always* be snapped to the grid whether it is
visible or not. The Tile Editing window also permits you to select
...
|                                                                        |                 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|------------------------------------------------------------------------|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](/assets/Images/Icons/Icon_Tile_Draw.png)      | **Pencil**      | This is the pencil tool. It uses the selected tile to paint in the Room Editor with the left mouse button ![](/assets/Images/Icons/Icon_LMB.png) and you can erase with the right mouse button ![](/assets/Images/Icons/Icon_RMB.png) . Note that the index value for the tile is shown at the bottom in the Room Status Bar in the Room Editor, and if you have multiple tiles selected for painting (ie: a [brush](../Tile_Set_Editors/Brush_Builder) ) then a list of all the tile indices used will be shown.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ![](/assets/Images/Icons/Icon_Tile_Erase.png)     | **Eraser**      | With the eraser tool you can use the left mouse button ![](/assets/Images/Icons/Icon_LMB.png) to erase a given tile in the room editor. Essentially, all this does is set the tile index to 0, which is the reserved "empty" tile.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ![](/assets/Images/Icons/Icon_Tile_Fill.png)      | **Fill**        | The fill tool permits you to fill an entire tilemap layer or a selection of tiles with the current tile brush. The brush you use can be a single tile or a composite brush made up of multiple tiles, or even a tile from the animation library and clicking ![](/assets/Images/Icons/Icon_LMB.png) on a layer will then fill in the tiles using the chosen brush. If you have not used the Selection Tool then the fill will work on all consecutive *empty* tiles, or all consecutive tiles *of the same index* . If you have a selection within the layer, then fill will be constrained to within that selection.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ![](/assets/Images/Icons/Icon_Tile_Line.png)      | **Line**        | When you select the Line Tool, clicking ![](/assets/Images/Icons/Icon_LMB.png) then dragging and releasing will create a line of tiles between where you clicked and where you released. If you have an area of the tile map layer selected using the Selection Tool, then the line will only be added within the selection bounds. Lines can be drawn using a single tile brush, a composite brush of various tiles, or an animated tile from the library.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ![](/assets/Images/Icons/Icon_Tile_Rectangle.png) | **Rectangle**   | When you select the Rectangle Tool, clicking ![](/assets/Images/Icons/Icon_LMB.png) then dragging and releasing will create a filled rectangle of tiles with the top left corner being where you click and the bottom right corner being where you release. If you have an area of the tilemap layer selected using the Section Tool, then the rectangle will only be added within the selection bounds. Rectangles can be drawn using a single tile brush, a composite brush of various tiles, or an animated tile from the library.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ![](/assets/Images/Icons/Icon_TileSelect.png)     | **Selection**   | This is the selection tool, which can be used to define an area of the tile layer for working on. You can click the left mouse button ![](/assets/Images/Icons/Icon_LMB.png) and then drag the mouse to create a rectangular area, or you can press ![](/assets/Images/Icons/Icon_Ctrl.png) / ![](/assets/Images/Icons/Icon_Cmd.png) + ![](/assets/Images/Icons/Icon_LMB.png) to add multiple selections and ![](/assets/Images/Icons/Icon_Alt.png) + ![](/assets/Images/Icons/Icon_LMB.png) to clear a part of the selection. To clear the whole selection you can press ![](/assets/Images/Icons/Icon_Escape.png) . When you have an area of a tile layer selected, the rest of the tools (Pencil, Flip, Rotate, etc...) will only work within the selected area. Note that you can also copy ( ![](/assets/Images/Icons/Icon_Ctrl.png) / ![](/assets/Images/Icons/Icon_Cmd.png) + " C "), cut ( ![](/assets/Images/Icons/Icon_Ctrl.png) / ![](/assets/Images/Icons/Icon_Cmd.png) + " X ") and paste ( ![](/assets/Images/Icons/Icon_Ctrl.png) / ![](/assets/Images/Icons/Icon_Cmd.png) + " **V** ") selected tiles within the room editor which will then switch the tool to the Pencil and permit you to paint the room layer with the selected tiles.       |
| ![](/assets/Images/Icons/Icon_Tile_Auto.png)      | **AutoTile**    | Clicking this tool enables the Auto tiling paint style. When this is active you can select any tile from the Autotile Libraries tab, and then paint it into the room layer and GameMaker will automatically change it to match the surrounding tiles, as long as you have correctly set up the [Auto Tile Tab](../Tile_Set_Editors/Auto_Tiles) . Note that selecting a tile from the tile set that is not part of the autotile libraries will reset the drawing tool to the standard Pencil tool.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ![](/assets/Images/Icons/Icon_Tile_Inherit.png)   | **Inheritance** | With this tool you can enable/disable [inheritance](Room_Inheritance) for specific tiles on a given layer. For this to work, the room must first be a child room and the layer must have it's inheritance switched *on* in the layer properties. When in this state, the room editor will colour all inherited tiles red by default, and clicking the right mouse button ![](/assets/Images/Icons/Icon_RMB.png) will switch off inheritance for that tile, and clicking the left mouse button ![](/assets/Images/Icons/Icon_LMB.png) will switch it back on again. In this way you can re-use elements from "base" rooms, only selectively changing the tiles that you require while inheriting all the rest.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ![](/assets/Images/Icons/Icon_Tile_Flip.png)      | **Flip**        | Clicking the Flip tool with the left mouse button ![](/assets/Images/Icons/Icon_LMB.png) (or using the keyboard shortcut " X " ) will flip the tile currently selected for drawing along the *horizontal* axis, without changing drawing tool (if you have a custom brush selected for drawing, the whole brush will flip). If you have no tile selected for drawing, but do have a group of tiles selected on a layer, then the flip tool will Flip the selected tiles.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ![](/assets/Images/Icons/Icon_Tile_Mirror.png)    | **Mirror**      | Clicking the Mirror tool with the left mouse button ![](/assets/Images/Icons/Icon_LMB.png) (or using the keyboard shortcut " Y " ) will mirror the tile currently selected for drawing along the *vertical* axis, without changing drawing tool (if you have a custom brush selected for drawing, the whole brush will mirror). If you have no tile selected for drawing, but do have a group of tiles selected on a layer, then the Mirror tool will mirror the selected tiles.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ![](/assets/Images/Icons/Icon_Tile_Rotate.png)    | **Rotate**      | Clicking the Rotate tool with the left mouse button ![](/assets/Images/Icons/Icon_LMB.png) (or using the keyboard shortcut " Z " ) will rotate the tile currently selected for drawing 90° *clockwise* , without changing drawing tool (if you have a custom brush selected for drawing, the whole brush will rotate). If you have no tile selected for drawing, but do have a group of tiles selected on a layer, then the Rotate tool will rotate the selected tiles.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |

Note that if you use the Selection Tool
![](/assets/Images/Icons/Icon_TileSelect.png) to
select a group of tiles in the room editor canvas and then either cut or
copy them, they will temporarily become the current brush for painting.
![](/assets/Images/Icons/Icon_Paths.png) [ Paths
Paths ](#) You can add a new path layer by clicking on the
![](/assets/Images/Icons/Icon_Paths.png) button.
This will add the new layer, and then open up the path properties
window:  
![](/assets/Images/Asset_Editors/Editor_Room_PathProperties.png)  
...
![](/assets/Images/Icons/Icon_LMB.png) , as well as
remove points using the right mouse button
![](/assets/Images/Icons/Icon_RMB.png) , or select
a point by clicking on it and dragging it around, *all within the actual
room editor* , making creating and editing paths very easy (although you
can still edit the path in the [Path Editor](../Paths) as normal
too). If you hold down
![](/assets/Images/Icons/Icon_Ctrl.png) /
![](/assets/Images/Icons/Icon_Cmd.png) +
![](/assets/Images/Icons/Icon_LMB.png) on different
path points, then they will all be selected and you can move them
together or delete them all from the menu option (explained below). If
you right click
![](/assets/Images/Icons/Icon_RMB.png) in the room
editor window while manipulating a path then you'll get the following
options:  
![](/assets/Images/Asset_Editors/Editor_Room_PathRMBMenu.png)  
...
click ![](/assets/Images/Icons/Icon_LMB.png) and
drag to translate, scale or rotate the entire path.
![](/assets/Images/Icons/Icon_Assets.png) [ Assets
Assets ](#) You can add a new asset layer by clicking on the
![](/assets/Images/Icons/Icon_Assets.png) button.
This will add the new layer, and then open up the asset layer properties
window:  
![](/assets/Images/Asset_Editors/Editor_Room_LayerAssetProperties.png)  
...
![](/assets/Images/Icons/Icon_LMB.png) to "paint"
them. Sprite assets are similar to tiles, only they can be fully
animated - if the sprite used has sub-images they will be shown -
...
or use the keys
![](/assets/Images/Icons/Icon_Ctrl.png) /
![](/assets/Images/Icons/Icon_Cmd.png) and the left
mouse button ![](/assets/Images/Icons/Icon_LMB.png)
...
![](/assets/Images/Icons/Icon_LMB.png) on it to
open the asset properties window:  
![](/assets/Images/Asset_Editors/Editor_Room_AssetProperties.png)  
...
![](/assets/Images/Icons/Icon_FX_Layer.png) [
Filter/Effect Filter/Effect ](#) You can add a new Filter/Effect layer
by clicking on the
![](/assets/Images/Icons/Icon_FX_Layer.png) button.
This will add the new layer, and then open up the asset layer properties
window:  
...
![](/assets/Images/Asset_Editors/Editor_Room_LayerFilterEffectOrder.png)  
