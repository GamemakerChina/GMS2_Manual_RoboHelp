...
the ![](/assets/Images/Icons/Icon_FX_Layer.png)
...
![](/assets/Images/Asset_Editors/Editor_Room_LayerFilterParameters.png)  
...
![](/assets/Images/Icons/Icon_Eye.png) icon to
enable/disable the FX for the selected layer.
