...
![](/assets/Images/Asset_Editors/Editor_Timelines.png)  
...
![](/assets/Images/Icons/Icon_RMB.png) on [Asset
Browser](../Introduction/The_Asset_Browser) and select "Create
Timeline". This will open the window pictured at the top of this page
with the following sections: [ Name Name ](#) Here you give your
...
click ![](/assets/Images/Icons/Icon_LMB.png) on the
moment value or you can use the right button
![](/assets/Images/Icons/Icon_RMB.png) menu and
select " *change* " (see the section on the button menu below) to change
it. To add a new moment, simply click the **Add** button at the bottom
of the editor. Adding new moments will open the [code
...
![](/assets/Images/Asset_Editors/Editor_Timelines_Name.png)  
The timeline editor permits you to use
![](/assets/Images/Icons/Icon_Space.png) +
![](/assets/Images/Icons/Icon_LMB.png) select all
moments between the first click
![](/assets/Images/Icons/Icon_LMB.png) and the
second click ![](/assets/Images/Icons/Icon_LMB.png)
, or you can use
![](/assets/Images/Icons/Icon_Ctrl.png) /
![](/assets/Images/Icons/Icon_Cmd.png) +
![](/assets/Images/Icons/Icon_LMB.png) to click on
single moments to select them independently. Timeline moments can be
edited using the right mouse button
![](/assets/Images/Icons/Icon_RMB.png) menu on one
of the selected elements:  
![](/assets/Images/Asset_Editors/Editor_Timelines_RMBMenu.png)  
...
-   **Add** : This option permits you to add a new moment to the
    ...
    moment value in the editor or by right-clicking
...
-   **Change Moment** : Change the value for the selected timeline
    ...
    ![](/assets/Images/Icons/Icon_LMB.png) on the
    timeline value in the editor window.
