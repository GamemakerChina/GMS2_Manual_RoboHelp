...
artist:  
![](/assets/Images/Asset_Editors/Canvas_Reference.png)  
...
![](/assets/Images/Asset_Editors/Canvas_Add_Asset.gif)  
...
the Track Panel. You can also see that a dotted line has been added to
the canvas view to indicate the movement through time of the asset. If
you do not have the automatic recording enabled, you can still add
points by moving the asset, then setting the playhead and then finally
clicking the " **Record a new key** "
![](/assets/Images/Icons/Icon_Seq_Add.png) button.
...
![](/assets/Images/Icons/Icon_LMB.png) on a ruler
and then dragging into the canvas:  
![](/assets/Images/Asset_Editors/Canvas_Adding_Guides.gif)  
...
![](/assets/Images/Asset_Editors/Canvas_Smart_Guides.gif)  
...
![](/assets/Images/Icons/Icon_LMB.png) ), and you
can scroll horizontally with the mouse wheel
...
you can select multiple assets using
![](/assets/Images/Icons/Icon_Ctrl.png) /
![](/assets/Images/Icons/Icon_Cmd.png) and
![](/assets/Images/Icons/Icon_LMB.png) to click on
each asset. You can also select multiple assets using
![](/assets/Images/Icons/Icon_Shift.png) and then
clicking ![](/assets/Images/Icons/Icon_LMB.png) and
dragging. This will create a "box" in the canvas and any asset that
...
combinations. Note that when multiple assets are selected in the canvas,
there will be a bounding box shown for each asset, and a larger bounding
box shown for all of them combined. You can change how this bounding box
behaves from the icons at the top left corner:  
![](/assets/Images/Asset_Editors/Canvas_BBox_Controls.png)  
...
it and edit it:  
![](/assets/Images/Asset_Editors/Canvas_Item_Toolbox.gif)  
You also have a number of additional options available to you from the
right mouse button
![](/assets/Images/Icons/Icon_RMB.png) when you
click it on any asset in the sequence:  
![](/assets/Images/Asset_Editors/Canvas_RMB_Menu.png)  
