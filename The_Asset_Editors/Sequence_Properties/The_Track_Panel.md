...
![](/assets/Images/Asset_Editors/Track_Panel.png)  
...
-   by clicking the "Add Asset"
    ![](/assets/Images/Icons/Icon_AddAsset.png)
...
![](/assets/Images/Asset_Editors/Track_Editor_Add_Asset.gif)  
...
Record Changes** "
![](/assets/Images/Icons/Icon_Seq_Record.png) in
the Track Panel, which will then add parameter keys for any changes you
make to an asset in the Canvas at the current playhead position, as
shown here:  
![](/assets/Images/Asset_Editors/Canvas_Add_Keys.gif)  
Alternatively, you can click the " **Add Parameter Track** "
![](/assets/Images/Icons/Icon_Add_Param.png)
button, which will open up a menu showing you the different options
available:  
![](/assets/Images/Asset_Editors/Track_Editor_Add_Parameter.png)  
...
![](/assets/Images/Asset_Editors/Track_Editor_ParameterTracks.png)  
...
dope sheet:  
![](/assets/Images/Asset_Editors/Track_Editor_Changing_Parameter.gif)  
...
![](/assets/Images/Icons/Icon_RMB.png) menu on the
parameter track, which means that transitions between parameter values
will occur *instantly* on the given frame rather than gradually over
time:  
![](/assets/Images/Asset_Editors/Track_Editor_RMB_Menu_Params.png)  
...
![](/assets/Images/Asset_Editors/Track_Editor_Parenting.gif)  
...
![](/assets/Images/Icons/Icon_Shift.png) and the
left mouse button
![](/assets/Images/Icons/Icon_LMB.png) to select
consecutive tracks, and you can also cut, copy and paste them using the
![](/assets/Images/Icons/Icon_Ctrl.png) /
![](/assets/Images/Icons/Icon_Cmd.png) +" X ",
![](/assets/Images/Icons/Icon_Ctrl.png) /
![](/assets/Images/Icons/Icon_Cmd.png) + " C " and
![](/assets/Images/Icons/Icon_Ctrl.png) /
![](/assets/Images/Icons/Icon_Cmd.png) + " V " key
combinations. That's the basics of using the track editor, but below we
go into a bit more detail on what each of the different sections are for
and how to use them: [ Change Orientation Change Orientation ](#) The
change orientation button
![](/assets/Images/Icons/Icon_ChangeOrientation.png)
...
![](/assets/Images/Icons/Icon_CanvasOptions.png) to
open a menu and select the layout that you want. The following layouts
are available:

|                                                                         |                  |                                                                                                                                                                                                                                                                                                         |
|-------------------------------------------------------------------------|------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](/assets/Images/Icons/Icon_Seq_SplitWindow.png) | **Split Window** | With this option the Sequence Editor will be split into two seperate windows, where the main IDE window will show the Canvas view in the full desktop and the new window will show the Dope Sheet and Track Editor. Clicking the button again will change the layout again and remove the extra window. |
| ![](/assets/Images/Icons/Icon_Seq_Top.png)         | **Snap Top**     | This option snaps the Track Editor and Dopesheet to the top of the IDE.                                                                                                                                                                                                                                 |
| ![](/assets/Images/Icons/Icon_Seq_Right.png)       | **Snap Right**   | This option snaps the Track Editor and Dopesheet to the right of the IDE.                                                                                                                                                                                                                               |
| ![](/assets/Images/Icons/Icon_Seq_Bottom.png)      | **Snap Bottom**  | This option snaps the Track Editor and Dopesheet to the bottom of the IDE (this is the default view.                                                                                                                                                                                                    |
| ![](/assets/Images/Icons/Icon_Seq_Left.png)        | **Snap Left**    | This option snaps the Track Editor and Dopesheet to the left of the IDE.                                                                                                                                                                                                                                |

You can also reset the Sequence Editor layout at any time by clicking
the Reset option
![](/assets/Images/Icons/Icon_Seq_Reset.png) . This
will restore the editor to it's default state and re-open any sections
that had been closed. [ Track Search Track Search ](#) This search box
permits you to quickly search through the various tracks of the sequence
to find the one you wish to edit. Typing any text here will tell you how
many asset tracks have been found with that string in them, and also
highlight the arrows to the side of the search box. Clicking these
arrows will skip to the first and consecutive assets that fulfill the
search criteria. [ Asset Tracks Asset Tracks ](#) Each asset that is
...
![](/assets/Images/Icons/Icon_LMB.png) on the arrow
icon to the left of the track name, and you can edit the track name by
using a slow double click
![](/assets/Images/Icons/Icon_LMB.png) on the track
and then giving it the name of your choice. Note that there are no
restrictions on the name you give and you can use spaces, non
...
**Record Key** "
![](/assets/Images/Icons/Icon_Seq_Add.png) or "
**Delete key** "
**![](/assets/Images/Icons/Icon_Seq_Delete.png)**
...
![](/assets/Images/Asset_Editors/Track_Editor_Add_Param_Key.gif)  
...
![](/assets/Images/Icons/Icon_Track_Link.png) next
to their values, which means they can be linked together. This is done
by clicking the icon to enable/disable linking, and when enabled,
...
![](/assets/Images/Icons/Icon_AddEvent.png) which
will open the following window:  
![](/assets/Images/Asset_Editors/Editor_Sequences_Events.png)  
...
-   ![](/assets/Images/Icons/Icon_Seq_Split.png) -
    This is the "Split selected keys" button. When you have selected one
    or more parameter keys in the dope sheet, you can then click this
    button and they will be split into two separate keys at the timeline
    playhead position:  
    ![](/assets/Images/Asset_Editors/Editor_Sequences_Split.gif)  
-   ![](/assets/Images/Icons/Icon_Seq_Delete.png) -
    ...
    ![](/assets/Images/Asset_Editors/Editor_Sequences_Delete.gif)  
-   ![](/assets/Images/Icons/Icon_Seq_Add.png) -
    ...
    ![](/assets/Images/Asset_Editors/Editor_Sequences_Record.gif)  
-   ![](/assets/Images/Icons/Icon_Seq_Record.png) -
    ...
    ![](/assets/Images/Asset_Editors/Editor_Sequences_Auto.gif)  

[ Visible / Lock Toggles Visible / Lock Toggles ](#) Both asset tracks
and parameter tracks have a button to toggle track visibility
![](/assets/Images/Icons/Icon_Track_Visible.png)
and to lock the track
![](/assets/Images/Icons/Icon_Track_Lock.png) . If
you disable the visibility of the track, then it will not be shown when
the sequence is run in a room, nor will it be shown in the sequence
...
![](/assets/Images/Asset_Editors/Track_Editor_Locked_And_Visible.png)  
...
![](/assets/Images/Icons/Icon_Add_Param.png) button
can be used to add a single parameter track to the selected asset track.
As mentioned earlier on this page, parameter tracks can be of various
different types depending on the asset that it is related to. Below is a
list of all the different parameter tracks available and what they refer
to, as well as the assets that they can be applied to:
...
-   **Scale** : The scale parameter is available for *sprite* , *object*
    ...
    "link"
    ![](/assets/Images/Icons/Icon_Track_Link.png)
...
-   ![](/assets/Images/Icons/Icon_AddAsset.png) -
    This button will open the Asset Explorer for you to pick an asset to
    use as a new track. Once selected the asset track will be created
    and frames added into the Dope Sheet at the current playhead
    position.
-   ![](/assets/Images/Icons/Icon_DuplicateAsset.png) -
    When you have selected one or more asset tracks in the track editor,
    clicking this button will duplicate them (along with any parameter
    tracks they may contain).
-   ![](/assets/Images/Icons/Icon_AddClipMask.png) -
...
-   ![](/assets/Images/Icons/Icon_AddGroup.png) -
    Clicking this will add a new group folder to the track editor, which
    can then be used to better organise tracks. You can add a track t a
    group by dragging the track onto the group folder and you can remove
    it again by dragging it out of the folder. Note that any asset that
    is added to a group folder will automatically be assigned the folder
    colour, although you can then edit the track colour for individual
    tracks so that it is different if required.
-   ![](/assets/Images/Icons/Icon_DeleteTrack.png) -
