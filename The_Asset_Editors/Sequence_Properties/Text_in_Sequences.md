...
by selecting the
![](/assets/Images/Icons/Icon_TextButton.png) **Add
a Text Track** button from the Canvas Toolbox, and then clicking (and
optionally dragging) in the Canvas to create a text track.  
...
![](/assets/Images/Asset_Editors/Sequences_Text/SeqTextEditFromInspector.png)  
...
![](/assets/Images/Asset_Editors/Sequences_Text/SeqTextResizeBehaviour.png)  
...
![](/assets/Images/Asset_Editors/Sequences_Text/SeqTextParameters.png)  
...
-   **Paragraph Scaling** : This is the space between each paragraph of
    ...
    ![](/assets/Images/Icons/Icon_Enter.png) .  
