...
![](/assets/Images/Scripting_Reference/GML/Overview/Multiple_Functions_Scripts.png)  
...
![](/assets/Images/Icons/Icon_f1.png) or click the
middle mouse button
![](/assets/Images/Icons/Icon_MMB.png) on the
function name to open the script that contains it for editing directly.
