...
![](/assets/Images/Icons/Icon_AssetMenu.png) (Fig.
1), to manually open the **Included Files** window (Fig. 2):

![Fig.
1](/assets/Images/Settings/Included_Files_Editor_Open.png)

![Fig.
2](/assets/Images/Settings/Included_Files.png)
...
folder.  
![](/assets/Images/Settings/Included_Files_Example.png)  
Once you have added files to the editor, you can double-click
![](/assets/Images/Icons/Icon_LMB.png) on them to
open up the **File Properties** :  
![](/assets/Images/Settings/Included_Files_Properties.png)  
