...
![](/assets/Images/Settings/Room_Manager.png)  
...
![](/assets/Images/Icons/Icon_AssetMenu.png) at the
top of the Asset Browser and selecting it from the menu that opens, or
you can simply click
![](/assets/Images/Icons/Icon_LMB.png) the icon to
the left of a room in the asset browser:  
![](/assets/Images/Settings/Room_Manager_Open.gif)  
...
![](/assets/Images/Icons/icon_RoomManager_Home.png)
...
the room you want to move up or down the list, and you can use
![](/assets/Images/Icons/Icon_Shift.png) and/or
![](/assets/Images/Icons/Icon_Ctrl.png) /
![](/assets/Images/Icons/Icon_Cmd.png) to select
multiple rooms then click and drag them to move them altogether:  
![](/assets/Images/Settings/Room_Manager_Move.gif)  
...
![](/assets/Images/Settings/Room_Manager_Inheritance.png)  
As with the Room Order tab, you can click
![](/assets/Images/Icons/Icon_LMB.png) and drag to
reorder the rooms, but note that selecting a child room and moving it to
a different parent will break the room inheritance with the original
parent and it will instead inherit the properties of the new room. Note
too that you can convert a child into a "full" room with no inheritance
by dragging it to the left of the list (the list border will become
highlighted), at which point it will simply become a room in its own
right. Rooms can have multiple children, and each child can also be a
parent and have their own children, for example:  
![](/assets/Images/Settings/Room_Manager_Inheritance_Example.png)  
...
![](/assets/Images/Settings/Room_Manager_Search.gif)  
...
![](/assets/Images/Settings/Room_Manager_MoveButtons.gif)  
...
![](/assets/Images/Icons/Icon_Shift.png) and/or
![](/assets/Images/Icons/Icon_Ctrl.png) /
![](/assets/Images/Icons/Icon_Cmd.png) , then click
the Create Group button and all the selected rooms will be added to the
group. Note that this *will* change the order of the rooms in your game,
and also note that if you choose to delete the group folder later, **any
rooms within the folder will be deleted too** (by default GameMaker will
warn you about this). You should also note that you can right click on
any room in the Room Manager to bring up the following menu:  
![](/assets/Images/Settings/Room_Manager_Room_RMB_Menu.png)  
